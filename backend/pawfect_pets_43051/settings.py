"""
Django settings for pawfect_pets_43051 project.
...
ROOT_URLCONF = 'pawfect_pets_43051.urls'
...
WSGI_APPLICATION = 'pawfect_pets_43051.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pawfect_pets_43051 API",
    "DESCRIPTION": "API documentation for pawfect_pets_43051 App",
    "VERSION": "v1",
}
